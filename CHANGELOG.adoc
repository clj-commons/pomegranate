...
https://github.com/clj-commons/pomegranate/compare/v1.3.26\...v1.3.27[commit log]
...
* Review dependencies, remove redundant, explain unreferenced by code
(https://github.com/clj-commons/pomegranate/issues/237[#237]),
(https://github.com/clj-commons/pomegranate/issues/239[#239])
(https://github.com/lread[@lread])
* Fix scm connection urls in pomegranate's pom
...
(https://github.com/clj-commons/pomegranate/issues/221[#221])
(https://github.com/lread[@lread])
